...
final class ArchiveAttendanceTest extends TestCase
{
    use RefreshDatabase;

    public function test_archive_existing_attendance(): void
    {
    ...
    public function test_archive_unknown_attendance_returns_404(): void
    {
        $response = $this->deleteJson(
