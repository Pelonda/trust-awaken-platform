...
final class RestoreAttendanceTest extends TestCase
{
    use RefreshDatabase;

    public function test_restore_archived_attendance(): void
    {
        ...
        $response = $this->postJson(
            "/api/v1/attendance/{$attendance->uuid}/restore"
        );
    ...
    public function test_restore_unknown_attendance_returns_404(): void
    {
        $response = $this->postJson(
            '/api/v1/attendance/00000000-0000-0000-0000-000000000000/restore'
        );
