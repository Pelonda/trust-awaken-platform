...
final class ArchiveCredentialTemplateTest extends TestCase
{
    use RefreshDatabase;

    public function test_archive_existing_credential_template(): void
    {
    ...
    public function test_archive_unknown_credential_template_returns_404(): void
    {
        $response = $this->deleteJson(
