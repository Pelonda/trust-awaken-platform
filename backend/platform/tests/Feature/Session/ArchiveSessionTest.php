...
final class ArchiveSessionTest extends TestCase
{
    use RefreshDatabase;

    public function test_archive_existing_session(): void
    {
        ...
        $this->assertSoftDeleted('program_sessions', [
            'uuid' => $session->uuid,
        ]);
    }

    public function test_archive_unknown_session_returns_404(): void
    {
        $response = $this->deleteJson(
