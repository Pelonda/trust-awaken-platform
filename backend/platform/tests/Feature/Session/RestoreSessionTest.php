...
final class RestoreSessionTest extends TestCase
{
    use RefreshDatabase;

    public function test_restore_archived_session(): void
    {
        ...
        $response = $this->postJson(
            "/api/v1/sessions/{$session->uuid}/restore"
        );
    ...
    public function test_restore_unknown_session_returns_404(): void
    {
        $response = $this->postJson(
            '/api/v1/sessions/00000000-0000-0000-0000-000000000000/restore'
        );
