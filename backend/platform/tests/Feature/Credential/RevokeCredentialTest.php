...
final class RevokeCredentialTest extends TestCase
{
    use RefreshDatabase;

    public function test_revoke_existing_credential(): void
    {
        ...
        $response = $this->postJson(
            "/api/v1/credentials/{$credential->uuid}/revoke"
        );
    ...
    public function test_revoke_unknown_credential_returns_404(): void
    {
        $response = $this->postJson(
            '/api/v1/credentials/00000000-0000-0000-0000-000000000000/revoke'
        );
