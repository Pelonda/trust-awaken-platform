...
final class RestoreCredentialTest extends TestCase
{
    use RefreshDatabase;

    public function test_restore_archived_credential(): void
    {
        ...
        $response = $this->postJson(
            "/api/v1/credentials/{$credential->uuid}/restore"
        );
    ...
    public function test_restore_unknown_credential_returns_404(): void
    {
        $response = $this->postJson(
            '/api/v1/credentials/00000000-0000-0000-0000-000000000000/restore'
        );
