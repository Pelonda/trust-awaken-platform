...
final class UpdateCredentialTest extends TestCase
{
    use RefreshDatabase;

    public function test_update_existing_credential(): void
    {
        ...
        $response = $this->putJson(
            "/api/v1/credentials/{$credential->uuid}",
            [
                'status' => 'revoked',
            ]
        );
    ...
    public function test_update_unknown_credential_returns_404(): void
    {
        $response = $this->putJson(
