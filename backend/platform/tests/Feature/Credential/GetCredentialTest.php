...
final class GetCredentialTest extends TestCase
{
    use RefreshDatabase;

    public function test_get_existing_credential(): void
    {
    ...
    public function test_get_unknown_credential_returns_404(): void
    {
        $response = $this->getJson(
